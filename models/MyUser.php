...
//       $this->scenario = MyUser::SCENARIO_REGISTRATION;
...
//        die;
    ...
    public function userActivate($actkey) {
        ...
        $user->scenario = MyUser::SCENARIO_FIRSTACTIVATION;
    ...
    public function reqResPassword() {
        ...
        $this->scenario = MyUser::SCENARIO_RESETPASSWORD;
        if ($this->validate()) {
            $user = $this->findByEmail($this->email);
            $user->scenario = MyUser::SCENARIO_RESETPASSWORD;
        }
